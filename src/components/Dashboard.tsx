...
import { Trash2, Plus, X, Camera, LogOut, Activity, Pencil, Check, History } from 'lucide-react';
        ...
        <div className="pb-32 px-5 pt-6 max-w-md mx-auto">
            ...
            <div className="flex justify-between items-center mb-8">
                <div className="flex items-center gap-4">
                    <div className="w-14 h-14 rounded-full p-[3px] bg-gradient-to-tr from-blue-500 to-emerald-500 shadow-lg shadow-blue-500/20">
                ...
                {showInput ? (
                    <form onSubmit={handleAdd} className="w-full bg-white p-5 rounded-[2rem] shadow-2xl border border-slate-100 animate-in fade-in zoom-in duration-300">
                        ...
                        <div className="flex flex-col gap-4">
                            ...
                            {/* Submit Button */}
                            <button type="submit" className="w-full bg-slate-900 hover:bg-slate-800 text-white rounded-2xl py-5 font-bold text-lg shadow-xl shadow-slate-900/20 transition-all active:scale-95 flex items-center justify-center gap-3 mt-2">
                                {editingId ? (
                                    <>
